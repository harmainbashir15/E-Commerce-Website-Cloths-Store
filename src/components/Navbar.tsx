...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 z-50 bg-amber-600 w-full">
      <nav className="max-w-screen-xl mx-auto flex justify-between items-center py-2 lg:px-4 px-2">
        <div className="flex lg:gap-x-8 gap-x-4 items-center">
          <h1 className="lg:text-[30px] text-[24px] font-bold">HB CLOTHING</h1>
          <ul className="hidden md:flex gap-x-1 items-center">
            {navItems.map((nav, index) => (
              <li
                key={index}
                className="text-zinc-900 hover:text-zinc-950 hover:bg-zinc-50 px-7 py-[6px] rounded-md transition-colors"
              >
            ...
            <li>
              <NavigationMenu>
                <NavigationMenuList>
                  <NavigationMenuItem>
                    <NavigationMenuTrigger className="text-zinc-900 hover:text-zinc-950 ">
